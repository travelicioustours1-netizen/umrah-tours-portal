...
import PromotionListingWhatsAppButton from "@/components/promotion/PromotionListingWhatsAppButton";
      ...
      <section className="bg-emerald-700 px-4 py-14 text-white">
        <div className="mx-auto max-w-6xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-base text-emerald-50 md:text-lg">
            Explore our latest travel offers, special deals and promotional
            packages.
          </p>
        </div>
      </section>
          ...
          {promotions.length === 0 ? (
            <div className="rounded-2xl border border-dashed bg-white px-6 py-16 text-center">
              ...
              <p className="mx-auto mt-2 max-w-md text-sm text-gray-500">
                Please check back soon for our latest Umrah and holiday offers.
              </p>
            ...
            <>
                  ...
                  >
                    ...
                    {promotion.whatsappUrl && (
                      <div className="px-6 pb-6">
                        <PromotionListingWhatsAppButton
              ...
              <section className="mt-10 rounded-2xl border border-emerald-100 bg-emerald-50 p-6 md:p-8">
                ...
                <p className="mt-3 max-w-3xl leading-7 text-gray-600">
                  Planning a trip to Azerbaijan from the UAE? Explore our
                  Azerbaijan holiday package starting from AED 999 and check
                  our Azerbaijan Tourist Visa assistance for eligible
                  travellers.
                </p>
