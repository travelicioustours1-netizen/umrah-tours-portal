...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-gray-200 bg-white shadow-sm">
          ...
          <div className="relative">
            ...
            {otherServicesOpen && (
              <>
                ...
                {/* Dropdown */}
                <div className="absolute right-0 top-full z-50 mt-3 w-[760px] rounded-2xl border border-gray-200 bg-white p-6 shadow-2xl">
      ...
      {/* Mobile Navigation */}
      {mobileOpen && (
        <div className="max-h-[calc(100vh-5rem)] overflow-y-auto border-t border-gray-200 bg-white lg:hidden">
                      ...
                      <div className="space-y-1">
                        {category.services.map((service) => (
                          <a
                            ...
                            rel="noopener noreferrer"
                            onClick={closeAllMenus}
                            className="flex items-center justify-between rounded-lg bg-white px-3 py-2.5 text-sm font-medium text-gray-700 shadow-sm transition hover:bg-emerald-50 hover:text-emerald-700"
                          >
                            {service.label}
